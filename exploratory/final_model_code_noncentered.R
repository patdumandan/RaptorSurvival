...
surv_mod_trial_sloran=stan(model_code="
 data{
 ...
 parameters {
  ...
  surv_mu[i]= inv_logit(alpha_sp[species[i]]+alpha_st[study[i]]+
...
saveRDS(surv_mod_trial_sloran, file="meta_survival_sloperandom.RDS")
post=rstan::extract(surv_mod_trial_sloran)$pred_y #predicted survival estimate
print(surv_mod_trial_sloran, pars=c("alpha", "mass_eff", "est_eff","diet_eff", "for_eff", "alpha_sp"))
